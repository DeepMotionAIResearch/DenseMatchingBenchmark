...
class WarpErrorRefinement(nn.Module):
    ...
    Args:
        ...
        batchNorm, (bool): whether use batch normalization layer
    ...
    def __init__(self, in_planes, batchNorm=True):
        ...
        self.conv_mix = conv_bn_relu(batchNorm, in_planes*4 + 1, in_planes, kernel_size=3, stride=1, padding=1, dilation=1, bias=False)
